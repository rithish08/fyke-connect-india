    ...
    >
      ...
      <div className="flex flex-col items-end justify-center pl-4 min-w-[85px] w-full max-w-[140px]">
        ...
        <Button
          ...
          className={`h-12 w-[40%] min-w-[70px] max-w-[110px] px-2 py-1 mb-1 rounded-lg font-semibold shadow transition-all duration-150 border-none outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-400
            ${hireRequested
